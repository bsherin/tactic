...
function OptionModule(props) {
  ...
  const [form_state, set_form_state, form_state_ref] = (0, _utilities_react.useStateAndRef)({
    ...blank_form
  });
  ...
  function handleCreate(new_item, update) {
    if (update) {
      ...
      pushCallback(() => {
        let new_form_state = Object.assign(_lodash.default.cloneDeep(form_state_ref.current), {
