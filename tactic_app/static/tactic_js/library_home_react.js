...
class LibraryHomeApp extends React.Component {
    ...
    render() {
        let tile_widget = React.createElement(LoadedTileList, { tsocket: tsocket });
        let collection_pane = React.createElement(LibraryPane, _extends({}, this.props, {
            res_type: "collection",
...
class CollectionToolbar extends React.Component {
    ...
    _import_collection(file_list) {
        ...
        $.getJSON(`${$SCRIPT_ROOT}get_resource_names/collection`, function (data) {
            showModalReact("Import collection", "New collection Name", CreateNewCollection, "NewCollection", data["resource_names"], checkboxes);
        });
    ...
    get context_menu_items() {
        return [{ text: "open", icon: "document-open", onClick: this.props.view_resource }, { text: "__divider__" }, { text: "rename", icon: "edit", onClick: this.props.rename_func }, { text: "duplicate", icon: "duplicate", onClick: this._collection_duplicate }, { text: "__divider__" }, { text: "download", icon: "cloud-download", onClick: this._downloadCollection }, { text: "__divider__" }, { text: "delete", icon: "trash", onClick: this._collection_delete, intent: "danger" }];
    }
    ...
    render() {
        return React.createElement(LibraryToolbar, { sendContextMenuItems: this.props.sendContextMenuItems,
...
class ProjectToolbar extends React.Component {
    ...
    get context_menu_items() {
        return [{ text: "open", icon: "document-open", onClick: this.props.view_resource }, { text: "__divider__" }, { text: "rename", icon: "edit", onClick: this.props.rename_func }, { text: "duplicate", icon: "duplicate", onClick: this._project_duplicate }, { text: "__divider__" }, { text: "delete", icon: "trash", onClick: this._project_delete, intent: "danger" }];
    }
...
class TileToolbar extends React.Component {
    ...
    get popup_buttons() {
        ...
        }, "timeline-line-chart"], ["D3Tile", () => {
            this._new_in_creator("D3TileTemplate");
        }, "timeline-area-chart"]]]];
    }

    get context_menu_items() {
        return [{ text: "edit", icon: "edit", onClick: this._view_named_tile }, { text: "edit in creator", icon: "annotation", onClick: this._creator_view_named_tile }, { text: "__divider__" }, { text: "load", icon: "upload", onClick: this._load_tile }, { text: "__divider__" }, { text: "rename", icon: "edit", onClick: this.props.rename_func }, { text: "duplicate", icon: "duplicate", onClick: this._tile_duplicate }, { text: "__divider__" }, { text: "delete", icon: "trash", onClick: this._tile_delete, intent: "danger" }];
    }
...
class ListToolbar extends React.Component {
    ...
    get context_menu_items() {
        return [{ text: "edit", icon: "document-open", onClick: this.props.view_resource }, { text: "__divider__" }, { text: "rename", icon: "edit", onClick: this.props.rename_func }, { text: "duplicate", icon: "duplicate", onClick: this._list_duplicate }, { text: "__divider__" }, { text: "delete", icon: "trash", onClick: this._list_delete, intent: "danger" }];
    }
...
class CodeToolbar extends React.Component {
    ...
    get context_menu_items() {
        return [{ text: "edit", icon: "document-open", onClick: this.props.view_resource }, { text: "__divider__" }, { text: "rename", icon: "edit", onClick: this.props.rename_func }, { text: "duplicate", icon: "duplicate", onClick: this._code_duplicate }, { text: "__divider__" }, { text: "delete", icon: "trash", onClick: this._code_delete, intent: "danger" }];
    }
