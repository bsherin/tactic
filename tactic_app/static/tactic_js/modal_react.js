...
function ModalDialog(props) {
  ...
  var _useState7 = (0, _react.useState)(null),
    ...
    current_value = _useState8[0],
    set_current_value = _useState8[1];
...
function ReportDialog(props) {
  var _useState19 = (0, _react.useState)(false),
    ...
    show = _useState20[0],
    set_show = _useState20[1];
  var _useState21 = (0, _react.useState)(false),
    _useState22 = _slicedToArray(_useState21, 2),
    save_as_collection = _useState22[0],
    set_save_as_collection = _useState22[1];
  var _useState23 = (0, _react.useState)(null),
    _useState24 = _slicedToArray(_useState23, 2),
    collection_name = _useState24[0],
    set_collection_name = _useState24[1];
  var _useState25 = (0, _react.useState)(null),
    _useState26 = _slicedToArray(_useState25, 2),
    use_dark_theme = _useState26[0],
    set_use_dark_theme = _useState26[1];
  var _useState27 = (0, _react.useState)(""),
    _useState28 = _slicedToArray(_useState27, 2),
    warning_text = _useState28[0],
    set_warning_text = _useState28[1];
  var _useState29 = (0, _react.useState)(false),
    _useState30 = _slicedToArray(_useState29, 2),
    collapsible = _useState30[0],
    set_collapsible = _useState30[1];
  var _useState31 = (0, _react.useState)(false),
    _useState32 = _slicedToArray(_useState31, 2),
    include_summaries = _useState32[0],
    set_include_summaries = _useState32[1];
  var input_ref = (0, _react.useRef)(null);
  (0, _react.useEffect)(function () {
    set_show(true);
    var default_name = props.default_value;
