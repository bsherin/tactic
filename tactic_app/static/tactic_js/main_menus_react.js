    ...
    render() {
        ...
        let choices = pruned_list.map((opt_name, index) => {
            if (opt_name.startsWith("divider")) {
                return React.createElement(MenuDivider, null);
            }
...
class ProjectMenu extends React.Component {
    ...
    _saveProjectAs() {
        ...
        postWithCallback("host", "get_project_names", { "user_id": window.user_id }, function (data) {
            let checkboxes;
            showModalReact("Save Project As", "New Project Name", CreateNewProject, "NewProject", data["project_names"], null, doCancel);
        });
    ...
    _exportAsJupyter() {
        ...
        postWithCallback("host", "get_project_names", { "user_id": user_id }, function (data) {
            ...
            showModalReact("Export Notebook in Jupyter Format", "New Project Name", ExportJupyter, "NewJupyter", data["project_names"], checkboxes);
        });
    ...
    render() {
        return React.createElement(MenuComponent, { menu_name: "Project",
...
class ColumnMenu extends React.Component {
    ...
    render() {
        return React.createElement(MenuComponent, { menu_name: "Column",
            option_dict: this.option_dict,
            icon_dict: this.icon_dict,
            disabled_items: this.props.disabled_items,
            hidden_items: []
...
class ViewMenu extends React.Component {
    ...
    render() {
        return React.createElement(MenuComponent, { menu_name: "View",
            option_dict: this.option_dict,
            icon_dict: this.icon_dict,
            disabled_items: [],
