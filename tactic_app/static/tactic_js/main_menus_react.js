...
exports.DocumentMenu = exports.ColumnMenu = void 0;
...
exports.ViewMenu = exports.RowMenu = exports.ProjectMenu = void 0;
...
var ProjectMenu = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ProjectMenu, [{
    ...
    key: "_saveProject",
    value: function _saveProject(lite_save) {
      // let console_node = cleanse_bokeh(document.getElementById("console"));
      var self = this;
      var result_dict = {
    ...
    get: function get() {
      ...
      var items = [{
        ...
        click_handler: function click_handler() {
          _this2._saveProject(false);
        }
      }, {
        name_text: "Save Lite",
        icon_name: "saved",
        click_handler: function click_handler() {
          _this2._saveProject(true);
        }
      }, {
        name_text: "divider1",
        icon_name: null,
    ...
    get: function get() {
      ...
      return {
        ...
        "Add Column": function AddColumn() {
          return _this5.props.addColumn(false);
        },
        "Add Column In All Docs": function AddColumnInAllDocs() {
          return _this5.props.addColumn(true);
        },
        "Delete Column": function DeleteColumn() {
          return _this5.props.deleteColumn(false);
        },
        "Delete Column In All Docs": function DeleteColumnInAllDocs() {
          return _this5.props.deleteColumn(true);
        }
      };
    }
  }, {
