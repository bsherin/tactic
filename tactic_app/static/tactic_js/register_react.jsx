...
class RegisterApp extends React.Component {
    ...
    _onFieldChange(field, value) {
     ...
     _submit_register_info() {
        ...
        data.password = pwd;
        postAjax("attempt_register", this.state.fields, function (result) {
            if (result.success) {
        ...
        return (
            ...
            <React.Fragment>
                <div className="d-flex flex-column" style={outer_style}>
                    <form onSubmit={e => {
                              e.preventDefault();
                              this._submit_register_info();
                            }}>
                        {field_items}
                     <div className="d-flex flex-row">
                        <Bp.Button icon="log-in" large={true} text="Submit" onClick={this._submit_register_info}/>
                     </div>
                    </form>
                </div>
            </React.Fragment>
