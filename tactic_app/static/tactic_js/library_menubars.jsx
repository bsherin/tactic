...
function CollectionMenubar(props) {
    ...
    function menu_specs() {
        let ms = {
            ...
            Edit: [
                {
                    name_text: "Rename Collection", icon_name: "edit", click_handler: () => {
                        props.rename_func()
                    }
                },
                {
                ...
                {
                    name_text: "Delete Collections", icon_name: "trash", click_handler: () => {
                        props.delete_func()
                    },
                    multi_select: true
                }
            ...
            Transfer: [
                {name_text: "Import Data", icon_name: "cloud-upload", click_handler: props.showCollectionImport},
                {
                    name_text: "Download Collection", icon_name: "download", click_handler: () => {
                        props.downloadCollection()
                    }
                },
                {
    ...
    function context_menu_items() {
        ...
        menu_items = menu_items.concat([
            ...
            {text: "duplicate", icon: "duplicate", onClick: props.duplicate_func},
            {text: "__divider__"},
            {text: "download", icon: "cloud-download", onClick: props.downloadCollection},
            {text: "__divider__"},
            {text: "delete", icon: "trash", onClick: props.delete_func, intent: "danger"}
        ]);
        return menu_items
...
CollectionMenubar = memo(CollectionMenubar);
    ...
    function menu_specs() {
        let ms = {
            Open: [
                ...
                {
                    name_text: "New Notebook", icon_name: "new-text-box",
                    click_handler: props.new_notebook, key_bindings: ["ctrl+n"]
                },
            ],
            Edit: [
                {
                    name_text: "Rename Project", icon_name: "edit", click_handler: () => {
                        props.rename_func()
                    }
                },
                {
                    name_text: "Duplicate Project", icon_name: "duplicate", click_handler: () => {
                        props.duplicate_func()
                    }
                },
                {
                    name_text: "Delete Projects", icon_name: "trash", click_handler: () => {
                        props.delete_func()
                    },
                    multi_select: true
                },
...
ProjectMenubar = memo(ProjectMenubar);
ProjectMenubar.propTypes = specializedMenubarPropTypes;

function TileMenubar(props) {
    function context_menu_items() {
        let menu_items = [{text: "edit", icon: "edit", onClick: props.view_named_tile},
            {text: "edit in creator", icon: "annotation", onClick: props.creator_view_named_tile},
        ];

        if (window.in_context) {
            menu_items.push({
                text: "edit in separate tab", icon: "edit", onClick: (resource) => {
                    props.view_named_tile(resource, true)
                }
            });
            menu_items.push({
                text: "edit in creator in separate tab", icon: "annotation", onClick: (resource) => {
        ...
        menu_items = menu_items.concat([
            {text: "__divider__"},
            {text: "load", icon: "upload", onClick: props.load_tile},
            {text: "unload", icon: "undo", onClick: props.unload_module},
            {text: "__divider__"},
            {text: "rename", icon: "edit", onClick: props.rename_func},
            {text: "duplicate", icon: "duplicate", onClick: props.duplicate_func},
            {text: "__divider__"},
    ...
    function menu_specs() {
        ...
        let ms = {
            ...
            Open: [
                {
                    name_text: "Open In Creator", icon_name: "document-open",
                    click_handler: props.creator_view, key_bindings: ["ctrl+o", "return"]
                },
                {
            ...
            Edit: [
                {
                    name_text: "Rename Tile", icon_name: "edit", click_handler: () => {
                        props.rename_func()
                    }
                },
                {
                    name_text: "Duplicate Tile", icon_name: "duplicate", click_handler: () => {
                        props.duplicate_func()
                    }
                },
                {
                    name_text: "Delete Tiles", icon_name: "trash", click_handler: () => {
                        props.delete_func()
                    },
                    multi_select: true
                },
            ...
            Load: [{
                name_text: "Load", icon_name: "upload", click_handler: () => {
                    props.load_tile()
                }
            },
                {
                    name_text: "Unload", icon_name: "undo", click_handler: () => {
                        props.unload_module()
                    }
                },
                {name_text: "Reset", icon_name: "reset", click_handler: props.unload_all_tiles},
            ],
            Compare: [{
                ...
                {
                    name_text: "Compare to Other Modules", icon_name: "comparison", click_handler: props.compare_tiles,
...
TileMenubar = memo(TileMenubar);
TileMenubar.propTypes = specializedMenubarPropTypes;

function ListMenubar(props) {
    function context_menu_items() {
        let menu_items = [{text: "edit", icon: "document-open", onClick: props.view_func}];
        if (window.in_context) {
            menu_items.push({
                text: "open in separate tab", icon: "document-open", onClick: (resource) => {
                    props.view_resource(resource, null, true)
    ...
    function menu_specs() {
        ...
        let ms = {
            ...
            Edit: [
                {
                    name_text: "Rename List", icon_name: "edit", click_handler: () => {
                        props.rename_func()
                    }
                },
                {
                    name_text: "Duplicate List", icon_name: "duplicate", click_handler: () => {
                        props.duplicate_func()
                    }
                },
                {
                    name_text: "Delete Lists", icon_name: "trash", click_handler: () => {
                        props.delete_func()
                    },
                    multi_select: true
                },
...
ListMenubar = memo(ListMenubar);
ListMenubar.propTypes = specializedMenubarPropTypes;

function CodeMenubar(props) {
    function context_menu_items() {
        let menu_items = [{text: "edit", icon: "document-open", onClick: props.view_resource}];
        if (window.in_context) {
            menu_items.push({
                text: "open in separate tab", icon: "document-open", onClick: (resource) => {
                    props.view_resource(resource, null, true)
    ...
    function menu_specs() {
        ...
        let ms = {
            ...
            Edit: [
                {
                    name_text: "Rename Code", icon_name: "edit", click_handler: () => {
                        props.rename_func()
                    }
                },
                {
                    name_text: "Duplicate Code", icon_name: "duplicate", click_handler: () => {
                        props.duplicate_func()
                    }
                },
                {
                    name_text: "Delete Code", icon_name: "trash", click_handler: () => {
                        props.delete_func()
                    },
                    multi_select: true
                },
