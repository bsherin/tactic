...
function start_post_load() {
    ...
    $.get($SCRIPT_ROOT + "/get_resource_module_template", function(template) {
        ...
        resource_managers["container_module"] = new ContainerManager("container_module", "container", resource_module_template, "#container-module", "notrepo", null, true, false);
        resource_managers["user_module"] = new UserManager("user_module", "user", resource_module_template, "#user-module", "notrepo", null, true, false);
