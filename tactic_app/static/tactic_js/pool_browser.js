...
function PoolBrowser(props) {
  ...
  function _viewTextFile() {
    _viewTextFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
      var node,
        data,
        path,
        _args9 = arguments;
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 13:
            ...
            errorDrawerFuncs.addFromError("Error viewing text file", _context9.t0);
          case 16:
          case "end":
  ...
  function _rename_func2() {
    _rename_func2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
      var node,
        path,
        new_name,
        the_data,
        ...
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 13:
            ...
            if (_context10.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error renaming", _context10.t0);
            }
            return _context10.abrupt("return");
          case 17:
          case "end":
  ...
  function _add_directory2() {
    _add_directory2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
      var node,
        sNode,
        initial_address,
        full_path,
        ...
        while (1) switch (_context11.prev = _context11.next) {
          ...
          case 14:
            ...
            if (_context11.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error adding directory", _context11.t0);
            }
            return _context11.abrupt("return");
          case 18:
          case "end":
  ...
  function _duplicate_file2() {
    _duplicate_file2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
      var node,
        sNode,
        src,
        _splitFilePath,
        ...
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 18:
            ...
            if (_context12.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error duplicating file", _context12.t0);
            }
            return _context12.abrupt("return");
          case 22:
          case "end":
  ...
  function _downloadFile2() {
    _downloadFile2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13() {
      var node,
        sNode,
        src,
        new_name,
      ...
      return _regeneratorRuntime().wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 16:
            _yield$getBlobPromise = _context13.sent;
          ...
          case 24:
            ...
            if (_context13.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error downloading from pool", _context13.t0);
            }
          case 27:
          case "end":
  ...
  function _MoveResource() {
    _MoveResource = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(src, dst) {
      var the_data;
      return _regeneratorRuntime().wrap(function _callee14$(_context14) {
        while (1) switch (_context14.prev = _context14.next) {
          ...
          case 8:
            ...
            errorDrawerFuncs.addFromError("Error moving resource", _context14.t0);
          case 11:
          case "end":
  ...
  function _move_resource2() {
    _move_resource2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
      var node,
        sNode,
        src,
        initial_address,
        ...
        while (1) switch (_context15.prev = _context15.next) {
          ...
          case 14:
            ...
            if (_context15.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error moving resource", _context15.t0);
            }
          case 17:
          case "end":
  ...
  function _delete_func2() {
    _delete_func2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
      var node,
        path,
        sNode,
        basename,
      ...
      return _regeneratorRuntime().wrap(function _callee16$(_context16) {
        while (1) switch (_context16.prev = _context16.next) {
          ...
          case 14:
            ...
            if (_context16.t0 != "canceled") {
              errorDrawerFuncs.addFromError("Error deleting", _context16.t0);
            }
          case 17:
          case "end":
  ...
  function _handleDrop() {
    _handleDrop = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(e, dst) {
      var files, src;
