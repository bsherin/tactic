...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } // noinspection XmlDeprecatedElement
...
var ContextApp = /*#__PURE__*/function (_React$Component) {
  ...
  function ContextApp(props) {
    ...
    var library_panel_props = (0, _library_home_react.library_props)();
    ...
    _this.library_omni_function = null;
    _this.state = {
      tab_ids: [],
    ...
    _this.saved_width = _this.state.tabWidth;
    _this.top_ref = /*#__PURE__*/_react["default"].createRef();
    _this.key_bindings = [[["tab"], _this._goToNextPane], [["shift+tab"], _this._goToPreviousPane], [["ctrl+space"], _this._showOmnibar], [["ctrl+w"], function () {
  ...
  _createClass(ContextApp, [{
    ...
    key: "_registerOmniFunction",
    value: function _registerOmniFunction(tab_id, the_function) {
      if (tab_id == "library") {
    ...
    value: function _handleCreateViewer(data) {
      ...
      this._addPanel(new_id, data.kind, data.res_type, data.resource_name, "spinner", function () {
        var new_panel = self.propDict[data.kind](data, drmethod, function (new_panel) {
          ...
          return self._registerOmniFunction(new_id, register_func);
        });
      });
    }
  }, {
        ...
        _this5._addPanel(new_id, data.kind, data.res_type, data.resource_name, "spinner", function () {
          var new_panel = self.propDict[data.kind](data, drmethod, function (new_panel) {
            _this5._updatePanel(new_id, {
              ...
              var pdict = self.state.tab_panel_dict[new_id];
            });
          }, function (register_func) {
            return self._registerOmniFunction(new_id, register_func);
          });
    ...
    key: "_contextOmniItems",
    value: function _contextOmniItems() {
      var _this6 = this;
      if (this.state.tab_ids.length == 0) return [];
      var omni_funcs = [["Go To Next Panel", "context", this._goToNextPane, "arrow-right"], ["Go To Previous Panel", "context", this._goToPreviousPane, "arrow-left"]];
      if (this.state.selectedTabID != "library") {
        omni_funcs = omni_funcs.concat([["Close Current Panel", "context", function () {
          _this6._closeTab(_this6.state.selectedTabId);
        }, "delete"], ["Refresh Current Panel", "context", function () {
          _this6._refreshTab(_this6.state.selectedTabId);
        }, "reset"]]);
      }
      var omni_items = [];
    ...
    value: function render() {
      ...
      // }
      if (!unified) {
        var _iterator4 = _createForOfIteratorHelper(this.resTypes),
          _step4;
        try {
      ...
      library_panel = /*#__PURE__*/_react["default"].createElement("div", {
        ...
        registerOmniFunction: function registerOmniFunction(register_func) {
          return self._registerOmniFunction("library", register_func);
        },
      ...
      var all_tabs = [ltab];
      var _iterator5 = _createForOfIteratorHelper(this.state.tab_ids),
        _step5;
      try {
        var _loop3 = function _loop3() {
          var tab_id = _step5.value;
          var tab_entry = _this7.state.tab_panel_dict[tab_id];
          var bclass = "context-tab-button-content";
          if (_this7.state.selectedTabId == tab_id) {
            bclass += " selected-tab-button";
          }
          ...
          if (tab_entry.panel == "spinner") {
            ...
            var TheClass = _this7.classDict[tab_entry.kind];
            var the_panel = /*#__PURE__*/_react["default"].createElement(TheClass, _extends({}, tab_entry.panel, {
              controlled: true,
              dark_theme: _this7.state.dark_theme // needed for error drawer and status
              ,
              handleCreateViewer: _this7._handleCreateViewer,
              setTheme: _this7._setTheme,
              am_selected: tab_id == _this7.state.selectedTabId,
              changeResourceName: function changeResourceName(new_name) {
                var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
                var change_title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
                _this7._changeResourceName(tab_id, new_name, change_title, callback);
              },
              changeResourceTitle: function changeResourceTitle(new_title) {
                return _this7._changeResourceTitle(tab_id, new_title);
              },
              changeResourceProps: function changeResourceProps(new_props) {
                var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
                _this7._changeResourceProps(tab_id, new_props, callback);
              },
              updatePanel: function updatePanel(new_panel) {
                var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
                _this7._updatePanel(tab_id, new_panel, callback);
              },
              goToModule: _this7._goToModule,
              registerLineSetter: function registerLineSetter(rfunc) {
                return _this7._registerLineSetter(tab_id, rfunc);
              },
              refreshTab: function refreshTab() {
                _this7._refreshTab(tab_id);
              },
              closeTab: function closeTab() {
                _this7._closeTab(tab_id);
              },
              tsocket: tab_entry.panel.tsocket,
              usable_width: _this7.state.usable_width,
              usable_height: _this7.state.usable_height
            }));
            wrapped_panel = /*#__PURE__*/_react["default"].createElement(_error_boundary.ErrorBoundary, null, /*#__PURE__*/_react["default"].createElement("div", {
              id: tab_id + "-holder",
              className: _this7.panelRootDict[_this7.state.tab_panel_dict[tab_id].kind]
            }, the_panel));
          }
          var icon_style = {
          ...
          if (tab_id == _this7.state.dragging_over) {
            bclass += " hovering";
          }
          if (tab_id == _this7.state.currently_dragging) {
          ...
          var new_tab = /*#__PURE__*/_react["default"].createElement(_core.Tab, {
            ...
            onDragStart: function onDragStart(e) {
              _this7._onDragStart(e, tab_id);
            },
            onDrop: function onDrop(e) {
              _this7._onDrop(e, tab_id);
            },
            onDragEnter: function onDragEnter(e) {
              _this7._onDragEnter(e, tab_id);
            },
            onDragOver: function onDragOver(e) {
              _this7._onDragOver(e, tab_id);
            },
            onDragLeave: function onDragLeave(e) {
              _this7._onDragLeave(e, tab_id);
            },
            ...
            icon: _this7.iconDict[tab_entry.kind],
            style: {
              verticalAlign: "middle",
              marginRight: 5
            },
      ...
      var dummy_tab = /*#__PURE__*/_react["default"].createElement(_core.Tab, {
        ...
        disabled: true,
        onDrop: function onDrop(e) {
          _this7._onDrop(e, "dummy");
        },
        onDragEnter: function onDragEnter(e) {
          _this7._onDragEnter(e, "dummy");
        },
        onDragOver: function onDragOver(e) {
          _this7._onDragOver(e, "dummy");
        },
        onDragLeave: function onDragLeave(e) {
          _this7._onDragLeave(e, "dummy");
        },
        tabIndex: -1,
        key: "dummy",
        panelClassName: "context-tab",
      ...
      var self = this;
      var sid = this.state.selectedTabId;
      var omniGetter;
      if (sid && sid in this.state.tab_panel_dict) {
        var the_dict = this.state.tab_panel_dict[sid];
      ...
      return /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement(_blueprint_navbar.TacticNavbar, {
        ...
        omniGetters: [omniGetter, this._contextOmniItems],
