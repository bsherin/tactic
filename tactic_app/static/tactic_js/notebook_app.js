...
exports.main_notebook_in_context = main_notebook_in_context;
...
function main_notebook_in_context(data, registerThemeSetter, finalCallback) {
  ...
  function _everyone_ready_in_context() {
    ...
    if (is_totally_new) {
      ...
      (0, _communication_react.postWithCallback)(main_id, "initialize_mainwindow", data_dict, _finish_post_load_in_context);
    } else {
      if (data.is_jupyter) {
