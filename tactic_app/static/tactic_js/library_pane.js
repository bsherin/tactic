...
function LibraryPane(props) {
  ...
  function _onTableSelection(_x2) {
  ...
  function _grabNewChunkWithRow(_x3) {
  ...
  function _handleRowSelection(_x5) {
  ...
  function _handleArrowKeyPress(_x6) {
  ...
  function _handleTableKeyPress(_x7) {
  ...
  function _view_named_tile(_x15) {
  ...
  function _creator_view_named_tile(_x16) {
