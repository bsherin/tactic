...
function combinedCompletions(context) {
  var extraSelfCompletions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  ...
  return {
    from: from,
    to: context.pos,
    options: [].concat(_toConsumableArray(filterCompletions(localCompletions)), _toConsumableArray(filterCompletions(languageCompletions)), _toConsumableArray(selfCompletions(context, extraSelfCompletions).options), _toConsumableArray(periodCompletions(context).options)),
    span: true
  };
}
create_api();