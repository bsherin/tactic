...
function combinedCompletions(context) {
  let extraSelfCompletions = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  ...
  return {
    from: from,
    to: context.pos,
    options: [...filterCompletions(localCompletions), ...filterCompletions(languageCompletions), ...selfCompletions(context, extraSelfCompletions).options, ...periodCompletions(context).options],
    span: true
  };
}
create_api();