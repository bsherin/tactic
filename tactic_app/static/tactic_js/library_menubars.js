...
exports.LibraryMenubar = exports.CodeMenubar = exports.ListMenubar = exports.TileMenubar = exports.ProjectMenubar = exports.CollectionMenubar = exports.AllMenubar = void 0;
    ...
    get: function get() {
      ...
      var ms = {
        New: [{
          ...
          click_handler: function click_handler() {
            _this3.props.new_in_creator("D3TileTemplate");
          }
        }, {
          name_text: "divider2",
          icon_name: null,
    ...
    get: function get() {
      ...
      var ms = {
        New: [{
          ...
          icon_name: "timeline-area-chart",
          click_handler: function click_handler() {
            _this11.props.new_in_creator("D3TileTemplate");
          }
        }],
        Open: [{
          name_text: "Open In Creator",
