...
function ModuleViewerApp(props) {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 11:
            ...
            errorDrawerFuncs.addFromError("Error saving module", _context4.t0);
            statusFuncs.stopSpinner();
          case 15:
            return _context4.abrupt("return", false);
          case 16:
  ...
  function _saveModuleAs2() {
    _saveModuleAs2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
  ...
  function _saveAndLoadModule2() {
    _saveAndLoadModule2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      var data;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 14:
            ...
            errorDrawerFuncs.addFromError("Error saving and loading module", _context6.t0);
            statusFuncs.clearStatusMessage();
            statusFuncs.stopSpinner();
  ...
  function _loadModule2() {
    _loadModule2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 11:
            ...
            errorDrawerFuncs.addFromError("Error loading module", _context7.t0);
            statusFuncs.clearStatusMessage();
            statusFuncs.stopSpinner();
          case 16:
          case "end":
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 14:
            ...
            errorDrawerFuncs.addFromError("Error saving and checkpointing", _context8.t0);
            statusFuncs.clearStatusMessage();
            statusFuncs.stopSpinner();
...
function module_viewer_main() {
  function gotProps(the_props) {
    var ModuleViewerAppPlus = (0, _sizing_tools.withSizeContext)((0, _theme.withTheme)((0, _modal_react.withDialogs)((0, _error_drawer.withErrorDrawer)((0, _toaster.withStatus)(ModuleViewerApp)))));
