...
class TileContainer extends React.Component {
    ...
    render() {
        ...
        return React.createElement(SortableComponent, { id: "tile-div",
            style: outer_style,
...
class TileComponent extends React.Component {
    ...
    _broadcastTileSize() {
        postWithCallback(this.props.tile_id, "TileSizeChange", { width: this.tdaWidth, height: this.tdaHeight });
    }
    ...
    render() {
        ...
        return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        !this.props.shrunk && React.createElement(GlyphButton, {
                            icon: "chevron-down",
                            handleClick: this._toggleShrunk }),
                        React.createElement(GlyphButton, { intent: "primary",
                            handleClick: this._toggleBack,
                            icon: "cog" }),
                        React.createElement(Shandle, { tile_name: this.props.tile_name })
                    )
                ),
                React.createElement(
                    "div",
                    ...
                    React.createElement(
                        ...
                        React.createElement(GlyphButton, { handleClick: this._toggleTileLog,
                            ...
                            icon: "console" }),
                        React.createElement(GlyphButton, { handleClick: this._logMe,
                            tooltip: "Send current display to log",
                            icon: "clipboard" }),
                        React.createElement(GlyphButton, { handleClick: this._logParams,
                            tooltip: "Send current parameters to log",
                            icon: "th" }),
                        React.createElement(GlyphButton, { intent: "warning",
                            handleClick: this._reloadTile,
                            tooltip: "Reload tile source from library and rerun",
                            icon: "refresh" }),
                        React.createElement(GlyphButton, { intent: "danger",
            ...
            !this.props.shrunk && React.createElement(
                "div",
                ...
                React.createElement(
                    ...
                    state => React.createElement(
                        "div",
                        { className: "tile-log", style: composeObjs(this.tile_log_style, this.transitionFadeStyles[state]) },
                        React.createElement(
                            "div",
                ...
                React.createElement(
                    ...
                    state => React.createElement(
                        "div",
                        { className: "front", style: composeObjs(this.front_style, this.transitionStylesAltDown[state]) },
                        React.createElement("div", { className: "tile-display-area", style: this.state.tda_style, ref: this.tda_ref, dangerouslySetInnerHTML: front_dict })
                    )
                )
            ),
            React.createElement(DragHandle, { position_dict: draghandle_position_dict,
