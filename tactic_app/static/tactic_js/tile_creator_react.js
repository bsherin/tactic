...
class CreatorApp extends React.Component {
    ...
    _selectLine(cm, lnumber) {
        ...
        if (doc.getLine(lnumber)) {
            doc.setSelection({ line: lnumber, ch: 0 }, { line: lnumber, ch: doc.getLine(lnumber).length }, { scroll: true });
        }
    }
    ...
    render() {
        ...
        let methods_panel = React.createElement(
            "div",
            { style: { marginTop: 30 } },
        ...
        let right_pane = React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    Tabs,
                    { id: "resource_tabs", selectedTabId: this.state.selectedTabId,
