...
function CreatorApp(props) {
  ...
  var _useStateAndRef9 = (0, _utilities_react.useStateAndRef)(props.draw_plot_code),
    ...
    draw_plot_code = _useStateAndRef10[0],
    set_draw_plot_code = _useStateAndRef10[1],
    draw_plot_code_ref = _useStateAndRef10[2];
  var _useStateAndRef11 = (0, _utilities_react.useStateAndRef)(props.jscript_code),
    _useStateAndRef12 = _slicedToArray(_useStateAndRef11, 3),
    jscript_code = _useStateAndRef12[0],
    set_jscript_code = _useStateAndRef12[1],
    jscript_code_ref = _useStateAndRef12[2];
  var _useStateAndRef13 = (0, _utilities_react.useStateAndRef)(props.extra_functions),
    _useStateAndRef14 = _slicedToArray(_useStateAndRef13, 3),
    extra_functions = _useStateAndRef14[0],
    set_extra_functions = _useStateAndRef14[1],
    extra_functions_ref = _useStateAndRef14[2];
  var _useStateAndRef15 = (0, _utilities_react.useStateAndRef)(props.globals_code),
    _useStateAndRef16 = _slicedToArray(_useStateAndRef15, 3),
    globals_code = _useStateAndRef16[0],
    set_globals_code = _useStateAndRef16[1],
    globals_code_ref = _useStateAndRef16[2];
  ...
  var _useStateAndRef17 = (0, _utilities_react.useStateAndRef)(props.export_list),
    _useStateAndRef18 = _slicedToArray(_useStateAndRef17, 3),
    export_list = _useStateAndRef18[0],
    set_export_list = _useStateAndRef18[1],
    export_list_ref = _useStateAndRef18[2];
  var _useStateAndRef19 = (0, _utilities_react.useStateAndRef)(props.render_content_line_number),
    _useStateAndRef20 = _slicedToArray(_useStateAndRef19, 3),
    render_content_line_number = _useStateAndRef20[0],
    set_render_content_line_number = _useStateAndRef20[1],
    render_content_line_number_ref = _useStateAndRef20[2];
  var _useStateAndRef21 = (0, _utilities_react.useStateAndRef)(props.draw_plot_line_number),
    _useStateAndRef22 = _slicedToArray(_useStateAndRef21, 3),
    draw_plot_line_number = _useStateAndRef22[0],
    set_draw_plot_line_number = _useStateAndRef22[1],
    draw_plot_line_number_ref = _useStateAndRef22[2];
  var _useStateAndRef23 = (0, _utilities_react.useStateAndRef)(props.extra_methods_line_number),
    _useStateAndRef24 = _slicedToArray(_useStateAndRef23, 3),
    extra_methods_line_number = _useStateAndRef24[0],
    set_extra_methods_line_number = _useStateAndRef24[1],
    extra_methods_line_number_ref = _useStateAndRef24[2];

  // const [category, set_category, category_ref] = useStateAndRef(props.category);

  var _useStateAndRef25 = (0, _utilities_react.useStateAndRef)(props.additional_save_attrs || []),
    _useStateAndRef26 = _slicedToArray(_useStateAndRef25, 3),
    additional_save_attrs = _useStateAndRef26[0],
    set_additional_save_attrs = _useStateAndRef26[1],
    additional_save_attrs_ref = _useStateAndRef26[2];
  var _useStateAndRef27 = (0, _utilities_react.useStateAndRef)(props.couple_save_attrs_and_exports),
    _useStateAndRef28 = _slicedToArray(_useStateAndRef27, 3),
    couple_save_attrs_and_exports = _useStateAndRef28[0],
    set_couple_save_attrs_and_exports = _useStateAndRef28[1],
    couple_save_attrs_and_exports_ref = _useStateAndRef28[2];
