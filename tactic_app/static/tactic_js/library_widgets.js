...
class LibraryOmnibar extends React.Component {
    ...
    render() {
        return React.createElement(Omnibar, { items: this.state.items,
...
class BpSelectorTable extends React.Component {
    ...
    _renderMenu(sortColumn) {
        ...
        return React.createElement(
            Menu,
            null,
            React.createElement(MenuItem, { icon: "sort-asc", onClick: sortAsc, text: "Sort Asc" }),
            React.createElement(MenuItem, { icon: "sort-desc", onClick: sortDesc, text: "Sort Desc" })
        );
    }
