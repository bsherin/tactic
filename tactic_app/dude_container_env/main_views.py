...
def post_from_client():
    ...
    common_data.client_worker.forward_client_post(task_packet)
    return jsonify({"success": True})
...
def set_mainwindow_property(main_id, prop_name, prop_value):
    common_data.dude_worker.post_task(main_id, "set_property", {"property": prop_name, "val": prop_value})
    return


def get_mainwindow_property(main_id, prop_name, callback):
    common_data.dude_worker.post_task(main_id, "get_property", {"property": prop_name}, callback)
    return
...
def export_data():
    ...
    common_data.dude_worker.post_task(data_dict["main_id"], "export_data",
...
def figure_source(tile_id, figure_name):
    encoded_img = common_data.dude_worker.post_and_wait(tile_id, "get_image", {"figure_name": figure_name})["img"]
