...
import datetime
import os
from dude_users import User, load_user
import common_data
...
class GlobalTileManager(object):
    ...
    def load_user_default_tiles(self, username):
        ...
        if the_user is not None:
            ...
            for tm in tm_list:
                common_data.dude_worker.post_task("host", "load_tile_module_task", {"tile_module_name": tm,
    ...
    def add_user_tile_module(self, username, category, tile_name, tile_module, tile_module_name, is_default=False):
        ...
        print("leaving add_user_tile_manager")
        return


common_data.global_tile_manager = GlobalTileManager()
