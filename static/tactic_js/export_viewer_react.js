...
function ExportsViewer(props) {
  ...
  const [, set_selected_export, selected_export_ref] = (0, _utilities_react.useStateAndRef)("");
  ...
  const [, set_type] = (0, _react.useState)(null);
  const [pipe_dict, set_pipe_dict] = (0, _react.useState)({});
  const [isWidget, setIsWidget] = (0, _react.useState)(false);
  const [widgetKind, setWidgetKind] = (0, _react.useState)(null);
  const [widgetId, setWidgetId] = (0, _react.useState)(null);
  const [initialWidgetDdata, setInitialWidgetData] = (0, _react.useState)(null);
  ...
  async function _updateExportsList() {
    try {
      let data = await (0, _communication_react.postPromise)(props.local_id, "get_full_pipe_dict", {}, props.local_id);
  ...
  function _eval(e = null) {
    ...
    (0, _communication_react.postWithCallback)(props.local_id, "evaluate_export", send_data, null, null, props.local_id);
    if (e) e.preventDefault();
  }
  function _stopMe() {
    _stopMySpinner();
    (0, _communication_react.postWithCallback)(props.local_id, "stop_evaluate_export", {}, null, null, props.local_id);
  }
  ...
  function _handleExportListChange(fullname, shortname, tilename, force_refresh = false) {
    ...
    (0, _communication_react.postWithCallback)(props.local_id, "get_export_info", {
