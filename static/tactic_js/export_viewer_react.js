...
function ExportsViewer(props) {
  ...
  var _useState23 = (0, _react.useState)(false),
    ...
    isWidget = _useState24[0],
    setIsWidget = _useState24[1];
  var _useState25 = (0, _react.useState)(null),
    _useState26 = _slicedToArray(_useState25, 2),
    widgetKind = _useState26[0],
    setWidgetKind = _useState26[1];
  var _useState27 = (0, _react.useState)(null),
    _useState28 = _slicedToArray(_useState27, 2),
    widgetId = _useState28[0],
    setWidgetId = _useState28[1];
  var _useState29 = (0, _react.useState)(null),
    _useState30 = _slicedToArray(_useState29, 2),
    initialWidgetDdata = _useState30[0],
    setInitialWidgetData = _useState30[1];
  ...
  (0, _tactic_socket.useSocketListener)(props.tsocket, "export-viewer-message", function (data) {
    if (data.local_id == props.local_id) {
      var handlerDict = {
        ...
        exportViewerWidgetUpdate: function exportViewerWidgetUpdate(data) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _communication_react.postPromiseMain)(props.local_id, "get_full_pipe_dict", {
  ...
  function _eval() {
    ...
    (0, _communication_react.postWithCallbackMain)(props.local_id, "evaluate_export", send_data, null, null, props.local_id);
    if (e) e.preventDefault();
  }
  function _stopMe() {
    _stopMySpinner();
    (0, _communication_react.postWithCallbackMain)(props.local_id, "stop_evaluate_export", {}, null, null, props.local_id);
  }
  ...
  function _handleExportListChange(fullname, shortname, tilename) {
    ...
    (0, _communication_react.postWithCallbackMain)(props.local_id, "get_export_info", {
