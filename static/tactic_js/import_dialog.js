...
function FileImportDialog(props) {
  ...
  var _useState21 = (0, _react.useState)([]),
    ...
    activeUploads = _useState22[0],
    setActiveUploads = _useState22[1];
  ...
  function _startS3Uploads2() {
    _startS3Uploads2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var files, _iterator5, _step5, file, relpath, resp, _resp$upload_info, url, fields, key, bucket, content_type;
  ...
  function _do_submit2() {
    _do_submit2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var msg, csv_options;
  ...
  function _onSending2() {
    _onSending2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(file, xhr, formData) {
  ...
  }, "Import Folder"), /*#__PURE__*/_react["default"].createElement("input", {
    ref: folderInputRef,
    type: "file",
