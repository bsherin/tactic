...
function TileDifferApp(props) {
  ...
  function _handleSelectChange() {
    _handleSelectChange = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(new_value) {
      var data, _t;
  ...
  function _saveFromLeft() {
    _saveFromLeft = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var data_dict, _t2;
        ...
        while (1) switch (_context2.n) {
          ...
          case 3:
            ...
            errorDrawerFuncs.addErrorDrawerEntry({
              ...
              content: "message" in _t2 ? _t2.message : ""
            });
          case 4:
