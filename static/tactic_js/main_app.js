...
function MainApp(props) {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 3:
                _context.p = 3;
                _t = _context.v;
                errorDrawerFuncs.addFromError("Error saving list", _t);
              case 4:
                return _context.a(2);
            }
          }, _callee, null, [[1, 3]]);
      ...
      return _regenerator().w(function (_context8) {
        while (1) switch (_context8.n) {
          ...
          case 7:
            _context8.p = 7;
            _t3 = _context8.v;
            errorDrawerFuncs.addFromError("Error changing doc", _t3);
          case 8:
  ...
  function _tile_command2() {
    _tile_command2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee9(menu_id) {
      var existing_tile_names, _iterator3, _step3, tile_entry, tile_name, data_dict, create_data, new_tile_entry, _t4;
      return _regenerator().w(function (_context9) {
        while (1) switch (_context9.n) {
          ...
          case 4:
            ...
            _t4 = _context9.v;
            if (_t4 != "canceled") {
              errorDrawerFuncs.addFromError("Error creating tile}", _t4);
            }
            statusFuncs.clearStatusMessage();
            statusFuncs.stopSpinner();
          case 5:
      ...
      return _regenerator().w(function (_context13) {
        while (1) switch (_context13.n) {
          ...
          case 3:
            ...
            _t5 = _context13.v;
            if (_t5 != "canceled") {
              errorDrawerFuncs.addFromError("Error adding column", _t5);
            }
          case 4:
      ...
      return _regenerator().w(function (_context14) {
        while (1) switch (_context14.n) {
          ...
          case 2:
            _context14.p = 2;
            _t6 = _context14.v;
            errorDrawerFuncs.addFromError("Error grabbing data chunk", _t6);
          case 3:
  ...
  function _removeCollection2() {
    _removeCollection2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15() {
      var result_dict, data_object, table_spec, _t7;
      return _regenerator().w(function (_context15) {
        while (1) switch (_context15.n) {
          ...
          case 2:
            _context15.p = 2;
            _t7 = _context15.v;
            errorDrawerFuncs.addFromError("Error removing collection", _t7);
          case 3:
  ...
  function _changeCollection2() {
    _changeCollection2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16() {
      var data, new_collection_name, result_dict, data_object, table_spec, _t8;
      return _regenerator().w(function (_context16) {
        while (1) switch (_context16.n) {
          ...
          case 4:
            ...
            _t8 = _context16.v;
            if (_t8 != "canceled") {
              errorDrawerFuncs.addFromError("Error changing collection", _t8);
            }
            statusFuncs.clearStatusMessage();
            statusFuncs.stopSpinner();
          case 5:
