...
function MainApp(props) {
  ...
  const [tile_list, tileDispatch, tile_list_ref] = (0, _utilities_react.useReducerAndRef)(_tile_container_support.tilesReducer);
  ...
  const _setMainStateValue = (0, _react.useCallback)((field_name, new_value = null, callback = null) => {
  ...
  let bottom_pane = /*#__PURE__*/_react.default.createElement(_resizing_allotment.HorizontalPanes, {
...
function main_main() {
  function gotProps(the_props) {
    let MainAppPlus = (0, _pool_tree.withPool)((0, _settings.withSettings)((0, _modal_react.withDialogs)((0, _error_drawer.withErrorDrawer)((0, _toaster.withStatus)((0, _assistant.withAssistant)(MainApp))))));
