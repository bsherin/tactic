...
function treeNodesReducer(nodes, action) {
  switch (action.type) {
    ...
    case "SET_CHILD_NODES":
      var newStateSCN = _lodash["default"].cloneDeep(nodes);
    ...
    case "MODIFY_DIRECTORY":
      ...
      if (!modified_dir) {
        var _splitFilePath3 = splitFilePath(action.folderDict.fullpath),
          ...
          _path2 = _splitFilePath4[0];
        forEachNode(newStateMD, function (node) {
          if (node.isDirectory) {
            if (node.fullpath == _path2) {
    ...
    case "ADD_FILE":
      ...
      var _splitFilePath5 = splitFilePath(action.fileDict.fullpath),
        _splitFilePath6 = _slicedToArray(_splitFilePath5, 1),
        path = _splitFilePath6[0];
    ...
    case "ADD_DIRECTORY":
      ...
      var _splitFilePath7 = splitFilePath(action.folderDict.fullpath),
        _splitFilePath8 = _slicedToArray(_splitFilePath7, 1),
        fpath = _splitFilePath8[0];
