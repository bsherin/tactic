...
const SHRINK_EXPAND_GLYPH_BUTTON_STYLE = {
  marginLeft: 2
};
const SHOW_EXPORTS_GLYPH_BUTTON_STYLE2 = {
  marginRight: 5,
  marginTop: 2
};
...
const searchable_console_style = {
  padding: 15
};
const sHandleStyle = {
  marginLeft: 0,
...
function ConsoleComponent(props) {
  ...
  const widgetHomesRef = (0, _react.useRef)({});
  const [, set_console_item_with_focus] = (0, _react.useState)(null);
  const [, set_console_item_saved_focus] = (0, _react.useState)(null);
  const [, set_search_string, search_string_ref] = (0, _utilities_react.useStateAndRef)(null);
  ...
  const _addBlankCode = (0, _react.useCallback)(async () => {
  ...
  const _copySection = (0, _react.useCallback)((unique_id = null) => {
    if (!unique_id) {
  ...
  const _copyCell = (0, _react.useCallback)((unique_id = null) => {
    let id_list;
    if (!unique_id) {
  ...
  const _setFocusedItem = (0, _react.useCallback)((unique_id, callback = null) => {
  ...
  const _setConsoleItemValue = (0, _react.useCallback)((unique_id, field, new_value, callback = null) => {
    props.dispatch({
  ...
  const _selectConsoleItem = (0, _react.useCallback)((unique_id, event = null, callback = null) => {
    let updates = {};
  ...
  function _moveSection({
    oldIndex,
    newIndex
  }, filtered_items, callback = null) {
  ...
  const _resortConsoleItems = (0, _react.useCallback)((oldIndex, newIndex) => {
  ...
  const _closeConsoleItem = (0, _react.useCallback)(async unique_id => {
    let centry = get_console_item_entry(unique_id);
    if (centry.type == "divider") {
  ...
  const _runCodeItem = (0, _react.useCallback)((unique_id, go_to_next = false) => {
  ...
  const _sortStart = (0, _react.useCallback)(({
    draggableId
  }) => {
...
function ConsoleCodeItem(props) {
  ...
  const simpleTableId = (0, _react.useRef)(null);
  (0, _react.useEffect)(() => {
    ...
    try {
      ...
      if (widgetKind in _widgets.widgetDict) {
        ...
        the_widget = /*#__PURE__*/_react.default.createElement("div", {
          ...
          custom_message: `Error in output widget ${widgetId} of kind ${widgetKind}`
        }, /*#__PURE__*/_react.default.createElement(WidgetComponent, {
          key: widgetId,
          widgetId: widgetId,
          main_id: props.main_id,
