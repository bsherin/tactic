...
function withErrorDrawer(WrappedComponent, lposition = "right", error_drawer_size = "30%") {
  function WithErrorComponent(props) {
    ...
    const [, set_contents, contents_ref] = (0, _utilities_react.useStateAndRef)({}); // the ref is necessary.

    const goToLineNumber = (0, _react.useRef)(null);
    const ucounter = (0, _react.useRef)(0);
    const local_id = (0, _react.useRef)(props.local_id);
    ...
    const _addEntry = (0, _react.useCallback)((data, open = true) => {
    ...
    const _addFromError = (0, _react.useCallback)((title, data, open = true) => {
      let content = "";
      if ("message" in data) {
