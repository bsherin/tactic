...
function code_viewer_props(data, registerDirtyMethod, finalCallback) {
  var local_id = data.local_id || (0, _utilities_react.guid)();
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          _context.p = 2;
          _context.n = 3;
          return (0, _communication_react.postPromise)("host", "update_code_task", result_dict, props.local_id);
        case 3:
            ...
            var _click_handler2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
              return _regenerator().w(function (_context3) {
                while (1) switch (_context3.n) {
                  case 0:
                    _context3.n = 1;
                    return (0, _resource_viewer_react_app.sendToRepository)("code", _cProp("resource_name"), dialogFuncs, statusFuncs, errorDrawerFuncs);
                  case 1:
      ...
      return _regenerator().w(function (_context5) {
        while (1) switch (_context5.n) {
          ...
          case 4:
            ...
            _context5.n = 5;
            return (0, _communication_react.postPromise)("host", "create_duplicate_code_task", result_dict, props.local_id);
          case 5:
            _context5.n = 6;
...
function code_viewer_main() {
  ...
  var tsocket = new _tactic_socket.TacticSocket("main", 5000, "code_viewer", local_id, /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6() {
    var data;
