...
function TileComponent(props) {
  ...
  return /*#__PURE__*/_react.default.createElement(_core.Card, {
    ...
    className: `back ${props.show_form ? "show-me" : "hide-me"}`,
    style: {
      width: "100%",
      height: "100%",
      overflow: "auto",
    ...
    className: `tile-log-area ${props.show_log ? "show-me" : "hide-me"}`,
    style: {
      width: "100%",
      height: "100%",
      position: "relative"
    ...
    className: `tile-display-area front ${show_front ? "show-me" : "hide-me"}`,
    style: {
      width: "100%",
      position: "relative"
    },
