...
var all_columns = exports.all_columns = ["icon:th", "name", "icon:upload", "created", "updated", "size"];
var base_columns = exports.base_columns = ["icon:th", "name", "icon:upload"];
function ColumnSelector(_ref) {
  var icon_dict = _ref.icon_dict,
    selectedColumns = _ref.selectedColumns,
    onColumnChange = _ref.onColumnChange;
  var toggleColumn = function toggleColumn(k) {
    var next = new Set(selectedColumns);
    if (next.has(k)) next["delete"](k);else next.add(k);
    onColumnChange(_toConsumableArray(next));
  };
  return /*#__PURE__*/_react["default"].createElement(_core.Popover, {
    placement: "bottom-start",
    content: /*#__PURE__*/_react["default"].createElement(_core.Menu, null, all_columns.map(function (k) {
...
function FilterBar(_ref2) {
  var kinds = _ref2.kinds,
    ...
    selectedKinds = _ref2.selectedKinds,
    onKindChange = _ref2.onKindChange,
    update_search_state = _ref2.update_search_state,
    _ref2$search_inside = _ref2.search_inside,
    search_inside = _ref2$search_inside === void 0 ? false : _ref2$search_inside,
    _ref2$search_metadata = _ref2.search_metadata,
    search_metadata = _ref2$search_metadata === void 0 ? false : _ref2$search_metadata,
  ...
  }, /*#__PURE__*/_react["default"].createElement(ResourceFilter, {
    kinds: kinds,
    icon_dict: icon_dict,
...
function ResourceFilter(_ref3) {
  var kinds = _ref3.kinds,
    icon_dict = _ref3.icon_dict,
    selectedKinds = _ref3.selectedKinds,
    onKindChange = _ref3.onKindChange;
  var noneSelected = selectedKinds.size === 0;
  var toggleKind = function toggleKind(k) {
    var next = new Set(selectedKinds);
    if (next.has(k)) next["delete"](k);else next.add(k);
    onKindChange(_toConsumableArray(next));
  };
  ...
  return /*#__PURE__*/_react["default"].createElement(_core.Popover, {
    ...
    })), /*#__PURE__*/_react["default"].createElement(_core.MenuDivider, null), kinds.map(function (k) {
      return /*#__PURE__*/_react["default"].createElement(_core.MenuItem, {
        key: k,
        shouldDismissPopover: false,
        icon: icon_dict[k],
...
function BpSelectorTable(props) {
  ...
  function computeColumnWidths() {
    ...
    var column_names = props.columns;
    ...
    _onCompleteRender2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 2:
            lastColumnRegion = _table.Regions.column(props.columns.length - 1);
