...
var _tactic_socket = require("../tactic_js/tactic_socket");
...
function creator_props(data, registerDirtyMethod, finalCallback) {
  ...
  function _readyListener() {
    _readyListener = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _everyone_ready_in_context(finalCallback);
          case 2:
          case "end":
  ...
  function _everyone_ready_in_context(_x) {
    return _everyone_ready_in_context2.apply(this, arguments);
  }
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return (0, _communication_react.postPromise)(module_viewer_id, "initialize_parser", the_content, module_viewer_id);
          case 5:
            data_object = _context2.sent;
            if (!window.in_context) {
